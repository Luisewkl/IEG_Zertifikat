...
const CURRICULUM = [
  ...
  },
  {
    ...
    title: 'Prompt Engineering 101 \u2014 Anthropic Best Practices',
    desc: 'Prompt Engineering als iterative Wissenschaft: die ideale Prompt-Struktur, XML-Tags, Analyse-Reihenfolge, Pre-filling und System Prompts.',
    duration: '25 Min.',
    videos: [
      { url: 'https://www.youtube.com/embed/ysPbXH0LpIE', title: 'Prompt Engineering 101', caption: 'Video 2.1 \u00b7 Prompt Engineering nach Anthropic Best Practices' },
    ],
    images: [],
    longContent: '',
    content: `
      ...
      Es hilft, <em>Testf\u00e4lle</em> zu erstellen, um sicherzustellen, dass die KI in der
      gew\u00fcnschten Dom\u00e4ne bleibt.</p>

      <h3>2. Die ideale Prompt-Struktur</h3>
      <p>Anthropic empfiehlt f\u00fcr komplexe Aufgaben:</p>
      <ol>
        <li><strong>Aufgabenbeschreibung:</strong> Rolle und Ziel festlegen.</li>
        <li><strong>Kontext &amp; Tonfall:</strong> Stil-Anweisungen.</li>
        <li><strong>Hintergrunddaten:</strong> Statische Informationen (idealerweise im System Prompt).</li>
        <li><strong>Detaillierte Anweisungen:</strong> Schritt-f\u00fcr-Schritt-Liste.</li>
        <li><strong>Beispiele (Few-Shot):</strong> Musterl\u00f6sungen f\u00fcr schwierige F\u00e4lle.</li>
        <li><strong>Wichtige Erinnerungen:</strong> Wiederholung der kritischsten Punkte am Ende.</li>
      </ol>

      <h3>3. Strukturierung durch XML-Tags</h3>
      <p>Verwende <strong>XML-Tags</strong> (z.B. <code>&lt;form&gt;</code>, <code>&lt;anweisungen&gt;</code>),
      um verschiedene Informationsarten voneinander abzugrenzen.</p>
      <div class="callout">
        <div class="callout-title">Warum XML-Tags?</div>
        <p>Tags geben dem Prompt eine klare Hierarchie. Claude kann gezielt auf einzelne Abschnitte zugreifen.</p>
      </div>

      <h3>4. Die Reihenfolge der Analyse</h3>
      <p><strong>\u201eAnalyze the Form before the Sketch\u201c:</strong> Zuerst klare Fakten (Formular), dann interpretative Daten (Skizze).</p>

      <h3>5. Kontrolle des Outputs</h3>
      <ul>
        <li><strong>Formatvorgaben:</strong> XML-Tags am Ende f\u00fcr Endergebnis-Extraktion.</li>
        <li><strong>Pre-filling:</strong> Antwort mit <code>{</code> beginnen lassen f\u00fcr JSON-Output.</li>
      </ul>

      <h3>6. Prompt Caching &amp; System Prompts</h3>
      <p>Statische Informationen geh\u00f6ren in den <strong>System Prompt</strong>. Durch Caching spart man Zeit und Ressourcen.</p>
    `,
    quiz: [
      {
        ...
        options: [
          ...
          'Als reine Programmieraufgabe f\u00fcr Entwickler',
          'Als empirischer, iterativer Prozess: einfach beginnen, Fehler analysieren, verbessern',
          'Als unwichtige Nebensache bei der KI-Nutzung'
        ],
        correct: 2,
        explanation: 'Prompt Engineering ist iterativ: einfach beginnen, Fehler analysieren, schrittweise verbessern.'
      },
      {
        q: 'Welche sechs Elemente umfasst die ideale Prompt-Struktur nach Anthropic?',
        options: [
          'Nur eine kurze Frage ohne Kontext',
          'Aufgabe, Kontext, Hintergrunddaten, Anweisungen, Beispiele und Erinnerungen',
          '\u00dcberschrift und ein einzelner Satz',
          'Ausschlie\u00dflich Code-Beispiele'
        ],
        correct: 1,
        explanation: 'Die sechs Elemente: Aufgabenbeschreibung, Kontext & Tonfall, Hintergrunddaten, Anweisungen, Beispiele (Few-Shot), wichtige Erinnerungen.'
      },
      {
        q: 'Was bewirkt die Pre-filling-Technik?',
        options: [
          'Sie \u00fcbersetzt Prompts automatisch in andere Sprachen',
          'Sie speichert Prompts dauerhaft in der Cloud',
          'Sie l\u00f6scht den Chat-Verlauf vor jeder neuen Anfrage',
          'Man gibt Claude den Anfang seiner Antwort vor (z.B. { f\u00fcr JSON), um das Format zu erzwingen'
        ],
        correct: 3,
        explanation: 'Pre-filling erzwingt ein bestimmtes Output-Format: Mit { beginnen = valides JSON.'
      },
      {
        ...
        options: [
          ...
          'Sie verschl\u00fcsseln den Prompt f\u00fcr mehr Sicherheit',
          'Sie haben keine Funktion und sind nur Dekoration'
        ],
        correct: 1,
      ...
      },
      {
        ...
        options: [
          'Beide gleichzeitig analysieren',
          'Erst die Skizze, dann das Formular',
          'Die Reihenfolge spielt keine Rolle',
          'Erst klare Fakten (Formular), dann interpretative Daten (Skizze)'
        ],
        correct: 3,
        explanation: 'Klare Fakten zuerst, dann interpretative Daten \u2014 so hat Claude den korrekten Kontext.'
      },
      {
        q: 'Warum geh\u00f6ren statische Informationen in den System Prompt?',
        options: [
          'Weil der System Prompt k\u00fcrzer ist als ein normaler Prompt',
          'Weil sie im normalen Prompt nicht funktionieren',
          'Weil Claude sie durch Caching nicht bei jeder Anfrage neu lernen muss',
          'Weil sie dort sch\u00f6ner formatiert werden'
        ],
        correct: 2,
        explanation: 'Prompt Caching: Statische Infos im System Prompt werden gecacht und m\u00fcssen nicht jedes Mal neu verarbeitet werden.'
      }
    ]
  },
  {
